    ...
    for target_number in target_numbers:
        ...
        try:
            ...
            if target_number not in result_dict:
                result_dict[target_number] = f"Error: '>  <coconut_id>' not found in {file_name}"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python isolate_coconut_id.py <sdf_file_directory> <comma_separated_number_list>")
        sys.exit(1)
